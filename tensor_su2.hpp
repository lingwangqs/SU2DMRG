...
public:
  ...
  void spin_operator_tensor_product_identity(tensor_su2&,int);
  void make_spinhalf_identity_start();
  void make_spinhalf_identity_end();
  ...
  void make_spinhalf_spinor_pull_through_left();
  void make_spinhalf_spinor_pull_through_right();
  void make_spinhalf_Qterm(tensor_su2&,tensor_su2&,tensor_su2&,tensor_su2&);
  void make_spinhalf_Qterm_2(tensor_su2&,tensor_su2&);
  void make_physical_fusion_operator(int);
  void make_physical_swap_operator(int);
  void make_boundary_comp();
  ...
  int svd(tensor_su2&,double,tensor_su2&,double,int&,double*);
  //void svd(tensor_su2&,double,tensor_su2&,double,int&,double*);
  void svd(tensor_su2&,double,tensor_su2&,double,int,int&,double*);
  ...
  void operator_transformation_step1(tensor_su2&,tensor_su2&,tensor*,int);
  void operator_transformation_step2(tensor_su2&,tensor_su2&,tensor_su2&,tensor*,tensor*,int);
  void operator_transformation_step3(tensor_su2&,tensor_su2&,tensor_su2&,tensor_su2&,tensor_su2&,tensor*,int);
  void operator_transformation_step4(tensor_su2&,tensor_su2&,tensor*,int);
  void operator_transformation_step5(tensor_su2&,tensor_su2&,tensor_su2&,tensor*,int);
  ...
  void betadouble(tensor_su2&,tensor_su2&);
  void betadouble(tensor_su2&,tensor_su2&,tensor_su2&);
  void operator_initial(tensor_su2&,tensor_su2&,tensor_su2&,tensor_su2&,int);
  void operator_transformation(tensor_su2&,tensor_su2&,tensor_su2&,tensor_su2&,tensor_su2&,int);
  void prepare_vec(tensor_su2&,tensor_su2&);
};
